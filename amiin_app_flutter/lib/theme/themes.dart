...
class AmiinThemeColors extends ThemeExtension<AmiinThemeColors> {
  ...
  final Color infoAccentDark;    // texte/bordure lisible sur infoAccentLight
  final Color infoAccentMid;
  final Color secretariatAccent; // turquoise — agenda, notes, chat
  final Color secretariatAccentLight;
  final Color secretariatAccentDark;
  final Color secretariatAccentMid;
  final Color alertColor;        // corail — alertes uniquement
  final Color alertColorLight;
  final Color success;           // vert — confirmations, statuts complétés
  final Color successLight;
  final Color background;
  final Color surface;
  final Color surface2;
  final Color ink;
  final Color midTone;           // texte secondaire, entre ink et muted
  final Color muted;
  final Color border;
  final Color onAccent;          // texte/icône sur fond accentué (boutons)
  ...
  const AmiinThemeColors({
    ...
    required this.infoAccentDark,
    required this.infoAccentMid,
    required this.secretariatAccent,
    required this.secretariatAccentLight,
    required this.secretariatAccentDark,
    required this.secretariatAccentMid,
  ...
  AmiinThemeColors copyWith({
    ...
    Color? infoAccent, Color? infoAccentLight, Color? infoAccentDark, Color? infoAccentMid,
    Color? secretariatAccent, Color? secretariatAccentLight,
    Color? secretariatAccentDark, Color? secretariatAccentMid,
    Color? alertColor, Color? alertColorLight,
    Color? success, Color? successLight,
    Color? background, Color? surface, Color? surface2,
    Color? ink, Color? midTone, Color? muted, Color? border, Color? onAccent,
    ...
    infoAccentDark: infoAccentDark ?? this.infoAccentDark,
    infoAccentMid: infoAccentMid ?? this.infoAccentMid,
    ...
    secretariatAccentDark: secretariatAccentDark ?? this.secretariatAccentDark,
    secretariatAccentMid: secretariatAccentMid ?? this.secretariatAccentMid,
    alertColor: alertColor ?? this.alertColor,
    alertColorLight: alertColorLight ?? this.alertColorLight,
  ...
  AmiinThemeColors lerp(ThemeExtension<AmiinThemeColors>? other, double t) {
    ...
    return AmiinThemeColors(
      ...
      infoAccentDark: Color.lerp(infoAccentDark, other.infoAccentDark, t)!,
      infoAccentMid: Color.lerp(infoAccentMid, other.infoAccentMid, t)!,
      ...
      secretariatAccentDark: Color.lerp(secretariatAccentDark, other.secretariatAccentDark, t)!,
      secretariatAccentMid: Color.lerp(secretariatAccentMid, other.secretariatAccentMid, t)!,
      alertColor: Color.lerp(alertColor, other.alertColor, t)!,
      alertColorLight: Color.lerp(alertColorLight, other.alertColorLight, t)!,
      ...
      midTone: Color.lerp(midTone, other.midTone, t)!,
  ...
  static const terre = AmiinThemeColors(
    ...
    infoAccentDark:             Color(0xFF8F6520),
    infoAccentMid:              Color(0xFFDEA844),
    secretariatAccent:          Color(0xFF1E8A8A),
    secretariatAccentLight:     Color(0xFFCCEBEB),
    secretariatAccentDark:      Color(0xFF135E5E),
    secretariatAccentMid:       Color(0xFF2AADAD),
    alertColor:                 Color(0xFFC75145),
    alertColorLight:            Color(0xFFF5D0CC),
    success:                    Color(0xFF2A7A5A),
    successLight:               Color(0xFFCCE8DD),
    background:                 Color(0xFFF2EFE9),
    surface:                    Color(0xFFFFFFFF),
    surface2:                   Color(0xFFE4E8F0),
    ink:                        Color(0xFF14213D),
    midTone:                    Color(0xFF4A5A7A),
